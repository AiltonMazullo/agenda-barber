...
function ClientForgotPasswordForm({ slug }: { slug: string }) {
...
export default function ClientForgotPasswordPage({ params }: PageProps) {
  const { slug } = use(params);

  return (
    <AuthCard
      title="Recuperar senha"
      description="Enviaremos um link de recuperação para seu e-mail"
      footer={
        <Link
    ...
    >
      <Suspense>
        <ClientForgotPasswordForm slug={slug} />
      </Suspense>
    </AuthCard>
  );
}

...
interface DialogNovoAgendamentoAPIProps {
  open: boolean;
...
export function DialogNovoAgendamentoAPI({
  open,
  onOpenChange,
  services,
  onCreate,
}: DialogNovoAgendamentoAPIProps) {
  ...
  async function handleSave() {
    ...
    // Combina data + hora local em ISO UTC
        ...
        <div className="px-6 py-5 space-y-4">
          <div className="space-y-1.5">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-surface-raised border-border text-white max-h-60 overflow-y-auto">
                {services.length === 0 ? (
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="bg-surface-base border-border text-white placeholder:text-text-faint focus-visible:ring-[#f5b82e]/30 h-10 font-mono text-xs"
            />
            <p className="text-[10px] text-text-faint">
              O backend ainda não expõe cadastro/listagem de clientes.
              Cole o CUID de um cliente existente se necessário.
            </p>
          </div>
